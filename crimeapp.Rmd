...
```{r}
x_axis <- input_slider(min = 2001, max = 2019, value = c(2001, 2019), label = "Range of Years", sep = "")
  ...
  server = function(..., session) {
    crime %>%
     ...
     layer_points() %>%
      ...
      add_axis("y", title_offset = 40, title = "Number of Arrests", properties = axis_props(title = list(fontSize = 15))) %>%
      add_axis("x", title_offset = 40, title = "Year", properties = axis_props(title = list(fontSize = 15)), format = "####") %>%
